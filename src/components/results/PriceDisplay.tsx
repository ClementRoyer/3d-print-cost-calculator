    ...
    <div className="space-y-2">
      ...
      <div className="flex rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 text-sm font-medium">
        <button
          ...
          className={`flex-1 py-1.5 transition-colors focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500 ${
        ...
        <button
          ...
          className={`flex-1 py-1.5 transition-colors focus:outline-none focus:ring-2 focus:ring-inset focus:ring-green-500 ${
